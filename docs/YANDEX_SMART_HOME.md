# Yandex Smart Home (Yaha Cloud)

Интеграция MagicAir создаёт стандартный объект `fan`, поэтому Yandex Smart
Home автоматически поддерживает включение, выключение и шесть скоростей Tion
...
В настройках интеграции **Yandex Smart Home → Объекты для передачи в УДЯ**
...
2. Откройте **Настройки → Инструменты разработчика → YAML** и выполните
   **Перезагрузку конфигурации YAML** для Yandex Smart Home. Если такого пункта
